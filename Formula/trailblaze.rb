...
class Trailblaze < Formula
  ...
  url "https://github.com/block/trailblaze/releases/download/v2026.08.07/trailblaze.jar"
  sha256 "f35d69db86273478d145eba2d6bff5bc51fd735a2e02ee2dfae5625ba653f8d3"
  license "Apache-2.0"
  ...
  resource "launcher" do
    url "https://github.com/block/trailblaze/releases/download/v2026.08.07/trailblaze"
